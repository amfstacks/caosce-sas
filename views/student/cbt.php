...
<body class="bg-slate-100 text-slate-800 font-sans antialiased h-screen flex flex-col overflow-hidden no-select" 
      x-data="cbtController()" 
            ...
            <div class="mt-auto border-t border-slate-200 bg-slate-50 p-4">
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="relative inline-block w-12 mr-2 align-middle select-none transition duration-200 ease-in">
                        <input type="checkbox" name="toggle" id="autoNextToggle" x-model="autoNext" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"/>
                        <label for="autoNextToggle" class="toggle-label block overflow-hidden h-6 rounded-full bg-slate-300 cursor-pointer"></label>
                    </div>
                </div>
